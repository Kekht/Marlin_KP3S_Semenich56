...
#define STRING_CONFIG_H_AUTHOR "(Semenich56)" // Who made the changes.
 ...
 *    61 : 100kΩ Formbot/Vivedino 3 50°C Thermistor - beta 3950
...
#define HEATER_0_MAXTEMP 310   // 300(максимальная температура)=310-10(HOTEND_OVERSHOOT)
...
#define BED_MAXTEMP      120   // 110(максимальная температура)=120-10(HOTEND_OVERSHOOT)
 ...
 */
#define HOTEND_OVERSHOOT 10   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT  максимальная температура - 10
#define BED_OVERSHOOT    10   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT  максимальная температура - 10
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 282.3
  #define DEFAULT_bedKi 55.13
  #define DEFAULT_bedKd 963.4
 ...
 */
// #define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current НЕ ВКЛЮЧАТЬ!---эТО КАМЕРА.
...
#define EXTRUDE_MINTEMP 185 //Температура минимальной Экструзии
...
#define EXTRUDE_MAXLENGTH 200 // Длина безостановочной длины движения экструдера в мм.
...
#define THERMAL_PROTECTION_HOTENDS // Enable thermal protection for all extruders        включена защита от перегрева Хотенед
#define THERMAL_PROTECTION_BED     // Enable thermal protection for the heated bed      включена защита от перегрева Стол
...
#define ENDSTOP_INTERRUPTS_FEATURE //лучше разгрузить процессор вашей Меги, путем включения прерываний для обработки концевых выключателей
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 159.60, 800, 910 } //указываем количество шагов на миллиметр для осей
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 100  } // указываем максимальную скорость для осей 

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 300, 10, 150 } // ...or, set your own edit limits ЛИМИТЫ в Меню
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 800 }  // максимальное ускорение для осей 

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 200, 2000 } // ...or, set your own edit limits ЛИМИТЫ в Меню
#endif
 ...
 */
#define DEFAULT_ACCELERATION          800    // X, Y, Z and E acceleration for printing moves ---------ускорение по умолчанию для всех осей
#define DEFAULT_RETRACT_ACCELERATION  800    // E acceleration for retracts-------------ускорение для отката
#define DEFAULT_TRAVEL_ACCELERATION   800    // X, Y, Z acceleration for travel (non printing) moves----------- ускорение для перемещений
...
#define CLASSIC_JERK  // Разрешил -------------------------------------
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 30, 30, 1, 10 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET  { +29.5, -11.5, -2.95 } //расстояние от датчика Bltouch 
...
#define PROBING_MARGIN 10 //    было 10мм  расстояние от края, чтоб не уперлось в прищепки

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (100*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (5*60) //было 4
...
#endif
#define PROBING_FANS_OFF          // Turn fans off when probing   ---ВКЛЮЧИЛ Отключение вентиля при пробах--------------------------
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
//#define DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo sensors

// Require minimum nozzle and/or bed temperature for probing
#define PREHEAT_BEFORE_PROBING //ВКЛЮЧИЛ преднагрев для проб
...
//#define DISABLE_X //ПРОВЕРИТЬ! 
//#define DISABLE_Y //ПРОВЕРИТЬ!
//#define DISABLE_Z //ПРОВЕРИТЬ!
//#define DISABLE_I
//#define DISABLE_J
//#define DISABLE_K
//#define DISABLE_U
...
//#define DISABLE_OTHER_EXTRUDERS   // Keep only the active extruder enabled //По умолчанию активный экструдер остается включенным, а все неактивные экструдеры отключаются. 
...
#define Z_AFTER_HOMING         20 // (mm) Height to move to after homing (if Z was homed) ОТВОД ГОЛОВЫ ПО Z ПОСЛЕ АВТОУСТАНОВКИ НУЛЯ
...
#define FILAMENT_RUNOUT_SENSOR  // ------------------------------------------------------------------------------------------
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 35 // было 25. после окончания филамента продолжайте печатать эту длину нити    перед выполнением сценария запуска
 ...
 */
//#define PREHEAT_BEFORE_LEVELING  Можно ВКЛЮЧИТЬ преднагрев перед автоуровнем-------------------------------------------------
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.1  // (mm) Comment out to use the last-measured height  БЫЛО 0,2
#endif
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 15     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 20 }   /// ИЗМЕНИЛ МЕСТО ПАРКОВКИ.
...
//
#define TONE_QUEUE_LENGTH 4 // Раскоментировал-размер буфера против блокировки очереди печати при звуках

//
// A sequence of tones to play at startup, in pairs of tone (Hz), duration (ms).
// Silence in-between tones.
//
//#define STARTUP_TUNE { 698, 300, 0, 50, 523, 50, 0, 25, 494, 50, 0, 25, 523, 100, 0, 50, 554, 300, 0, 100, 523, 300 } // Раскоментировал - при включении мелодия.
 ...
 */
#define TFT_ROTATION TFT_ROTATE_180  ///  горизонтальный экран.
...
#define FAN_SOFT_PWM         //Убираем «свист» вентиляторов от ШИМ
...
// :[0,1,2,3,4,5,6,7]
#define SOFT_PWM_SCALE 0 //Было 2
