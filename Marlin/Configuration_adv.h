...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 145 }, { 30, 30 }, { 140, 30 }, { 140, 145 } }
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) Задаем режим работы чоппера SpreadCycle
